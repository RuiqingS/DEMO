...
def compute_qm9_smiles(dataset_name, remove_h, xtb):
    '''
    ...
    class StaticArgs:
        def __init__(self, dataset, remove_h):
            ...
            self.datadir = 'qm9/xtb' if xtb else 'qm9/temp'
            self.remove_h = remove_h
            self.include_charges = True
    args_dataset = StaticArgs(dataset_name, remove_h)
    args_dataset.xtb = True if xtb else False
...
def retrieve_qm9_smiles(dataset_info, xtb=None):
    ...
    if xtb:
        file_name = 'qm9/xtb/%s_smiles_xtb.pickle' % pickle_name
    else:
    ...
    try:
        ...
        try:
            ...
            pass
        qm9_smiles = compute_qm9_smiles(dataset_name, remove_h=not dataset_info['with_h'], xtb=xtb)
...
class BasicMolecularMetrics(object):
    def __init__(self, dataset_info, dataset_smiles_list=None, xtb=None):

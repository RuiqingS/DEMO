...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default="qm9_first_half", metavar='N',
                        help='qm9_first_half')
    parser.add_argument('--datadir', type=str, default="../temp", metavar='N',
                        help='qm9_first_half')
    ...
    #flow_state_dict = torch.load('./qm9/property_prediction/outputs/gap/best_checkpoint.npy',
    #                            map_location='cuda:0')
    #with open('./qm9/property_prediction/outputs/gap/args.pickle', 'rb') as f:
    #    args = pickle.load(f)
    ...
    for epoch in range(0, args.epochs):
        #test(model, epoch, dataloaders['test'], mean, mad, args.property, device, log_interval=args.log_interval)

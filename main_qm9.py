...
parser.add_argument('--train_diffusion', action='store_true', default='trainable_ae',
...
parser.add_argument("--conditioning", nargs='+', default=["Cv"],
...
def main():
    ...
    if hasattr(args, 'best_nll_val'):
        best_nll_val = args.best_nll_val
    else:
        best_nll_val = 1e8
        args.best_nll_val = best_nll_val

    if hasattr(args, 'best_nll_test'):
        best_nll_test = args.best_nll_test
    else:
        best_nll_test = 1e8
        args.best_nll_test = best_nll_test
    for epoch in range(args.start_epoch, args.n_epochs):
        ...
        if epoch % args.test_epochs == 0:
            ...
            if nll_val < args.best_nll_val:
                args.best_nll_val = nll_val
                args.best_nll_test = nll_test
                if args.save_model:

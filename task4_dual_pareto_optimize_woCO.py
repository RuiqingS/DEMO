    ...
    for Obj in combinations:
        ...
        for NPops in NPops_numbers:
            ...
            for indextime in range(numberoforun):
                ...
                tracker.update(Pop, Obj, AddNoise=current_noise, score=scheduler.score)
                ...
                for iter_idx in range(gens):
                    ...
                    # 繁殖与去噪
                    Off = evo.denoise_same_level(Parent, model, max_n_nodes, device, dataset_info, preds, True)
